...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-xfce/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-xfce/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-xfce/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-xfce](https://github.com/samwhelp/debian-iso-builder-remix-xfce)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-xfce.git
```


> change dir to `debian-iso-builder-remix-xfce`

``` sh
cd debian-iso-builder-remix-xfce
```
...
> change dir to `~/work/debian-iso-builder-remix-xfce/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-xfce/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-xfce/iso-profile/dist`
